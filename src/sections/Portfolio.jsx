    ...
    return(
        <div className="sm:px-10 sm:pt-12 sm:pb-32 lg:px-24 lg:pt-20 lg:pb-64 shadow-xl hover:shadow-jevon-dark-tx">
            <section id="portfolio" className="px-5 text-center">
                ...
                <div className="flex lg:items-stretch gap-8 py-10 sm:block">
                    <div className="flex justify-center shadow-md sm:container-sm sm:my-4 lg:w-1/2 p-5 rounded-3xl border-x-2 border-jevon-dark-tx hover:border-jevon-gold hover:shadow-jevon-gold">
                        <div>
                        <h3  className="rounded-lg font-bold text-jevon-gold">Home nVentory</h3>
                            ...
                            <p className="my-5">Technologies used by me in this project:</p>
